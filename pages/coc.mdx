...
export const meta = {
  ...
  tags: ["community", "safety", "coc"],
  description:
    "Code of Conduct for The Worst Dev on all digital platforms and in public spaces organized by Kurt Kemple",
};
...
- If this doesn’t happen, or if you’re uncomfortable speaking up, contact admins by emailing [theworstdev.o7x9oj@zapiermail.com](mailto:theworstdev.o7x9oj@zapiermail.com).
...
If you are being harassed by a member of our community, notice that someone else is being harassed, or have any other concerns, please contact the administrators via [theworstdev.o7x9oj@zapiermail.com](mailto:theworstdev.o7x9oj@zapiermail.com). If the person who is harassing you is on the admin team, they will not be involved in handling or resolving the incident.

The admin team will respond to any complaint as promptly as possible we can. If you do not get a timely response (for example, if no admins are currently online) then please put your personal safety and well-being first, and consider logging out and/or contacting the admins by email at [theworstdev.o7x9oj@zapiermail.com](mailto:theworstdev.o7x9oj@zapiermail.com).
...
This Code of Conduct is adapted from the Party Corgi Network CoC (https://partycorgi.com/coc/).
