...
description: In recent years there have been huge shifts in both back-end and front-end development. As clients become more and more stateful, the services backing them become slimmer and stateless.
---
...
Frameworks like [Expo](https://expo.io/), [Ionic](https://ionicframework.com/), [Gatsby](https://www.gatsbyjs.org/), [Next.js](https://nextjs.com), and [Meteor](https://www.meteor.com/) are making it possible to build production ready, quality apps, based on their building blocks.

## The Best of Both Worlds

What we're seeing now is platforms that encompass the best of both worlds. Providing solutions for the entire development life cycle of an application. Making it much easier to build fully fledged applications that can scale without question and costs less than building out your own serverless infrastructure and tooling. Solutions like [Firebase](https://firebase.google.com/), [Netlify](https://netlify.com), [Vercel](https://vercel.com), and [AWS Amplify](https://docs.amplify.aws/) provide full-stack features such as toolkits and APIs, data storage, file storage, and build and deployment services. I refer to these types of platforms as `Full-stack Serverless`. They provide feature sets that generally span from the command line tooling to back-end services, and everything in between.
...
<Tweet align="center" tweetLink="kurtkemple/status/1109126793938767872" />
