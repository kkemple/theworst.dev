...
<DarkModeImage
  light="/content-prework-light.png"
  dark="/content-prework-dark.png"
  alt="The illustration shows five steps to the left. Three of the steps (Objective, Motivation, and Persona) are grouped under “Content Scoping” and the other two options (Hook and Questions) are grouped under “Content Discovery.”"
/>
