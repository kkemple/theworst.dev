...
export const meta = {
  ...
  tags: ["zapier", "productivity", "automation"],
  description:
    "Recently I've been making heavy use of Zapier to automate tasks that were stealing a lot of my time and focus. The more I automate, the more time and focus I get back which is incredibly invaluable.",
};
