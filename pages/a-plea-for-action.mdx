...
export const meta = {
  ...
  tags: ["BlackLivesMatter", "BLM", "BLACK_LIVES_MATTER"],
  description:
    "By choosing to not take action on behalf of the Black community, you are choosing to say \"we don't view your struggles as our own\". In situations like this it's important to know where a company stands.",
};
