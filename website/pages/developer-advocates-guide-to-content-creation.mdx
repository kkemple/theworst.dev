...
These are the questions you think people might have about your topic, combined with any questions raised during content discovery. These questions provide insight into what the post should contain and form the basis of the content outline.
...
Once you have your questions, the goal is to distill them into an outline by looking for logical groupings in the questions and then ordering them appropriately. The end result is the outline for your blog post.

> This is the acceptance criteria for this content, and once all sections are filled out, the post can be considered complete! 🥳
