...
To sum it up, there is a lot of functionality that makes it hard to use Twitch Studio for very complex stream scene organization and use, or if you have guests.
